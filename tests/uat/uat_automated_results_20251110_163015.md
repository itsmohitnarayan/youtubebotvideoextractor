...
|------|--------|----------|----------|
| Config instance created successfully | PASS | CRITICAL | Config file: config.json |
| Config has 'monitoring check interval' | PASS | HIGH | Value: 10 |
| Config has 'download directory' | PASS | HIGH | Value: downloads |
| Config has 'max concurrent downloads' | PASS | HIGH | Value: 2 |
| Config has 'retry attempts' | FAIL | HIGH | Value: None |
| Config has 'active hours start' | PASS | HIGH | Value: 10:00 |
| Config has 'active hours end' | PASS | HIGH | Value: 22:00 |
| max_concurrent_downloads in valid range (1-10) | PASS | MEDIUM | Value: 2 |
| retry_attempts in valid range (0-5) | PASS | MEDIUM | Value: 0 |
| Data directory is writable | PASS | HIGH | Path: D:\2025\youtubebotvideoextractor\data |
...
| File exists: src/core/database.py | PASS | HIGH | Path: D:\2025\youtubebotvideoextractor\src\core\da... |
| File readable: src/core/database.py | PASS | MEDIUM |  |
...
| Package 'google-api-python-client' importable | PASS | HIGH | Import name: googleapiclient |
...
| Package 'PyQt5-Qt5' importable | PASS | HIGH | Import name: PyQt5.QtCore |
| Package 'PyQt5-sip' importable | PASS | HIGH | Import name: PyQt5.sip |
...
| Memory usage idle < 100 MB | PASS | HIGH | Current: 70.67 MB |
