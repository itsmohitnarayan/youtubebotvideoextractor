...
| Table 'upload_history' exists | ❌ FAIL | HIGH | Tables found: videos, sqlite_sequence, logs, stats... |
| Column 'videos.id' exists | ✅ PASS | MEDIUM | Columns: id, source_video_id, source_title, source... |
| Column 'videos.video_id' exists | ❌ FAIL | MEDIUM | Columns: id, source_video_id, source_title, source... |
| Column 'videos.title' exists | ❌ FAIL | MEDIUM | Columns: id, source_video_id, source_title, source... |
...
| Invalid URL rejected: http://www.youtube.com/watch?v=invalid... | ❌ FAIL | HIGH | Validation result: (False, 'Only HTTPS URLs are al... |
...
| Path validation: normal_file.txt... | ❌ FAIL | CRITICAL | Expected: True, Got: (True, '') |
...
| Memory usage idle < 100 MB | ✅ PASS | HIGH | Current: 68.09 MB |
...
| Test | Status | Severity | Details |
|------|--------|----------|----------|
| Project Overview has content (> 1 KB) | ✅ PASS | HIGH | Size: 11,096 bytes |
