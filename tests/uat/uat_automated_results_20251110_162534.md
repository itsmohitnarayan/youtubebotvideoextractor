...
| Package 'google-api-python-client' importable | FAIL | HIGH | Package not installed (tried importing 'googleapic... |
...
| Package 'PyQt5-Qt5' importable | FAIL | HIGH | Package not installed (tried importing 'PyQt5.QtCo... |
| Package 'PyQt5-sip' importable | FAIL | HIGH | Package not installed (tried importing 'PyQt5.sip'... |
