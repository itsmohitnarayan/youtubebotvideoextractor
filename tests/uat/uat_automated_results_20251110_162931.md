...
| Config has 'monitored_folders' | FAIL | HIGH | Value: None |
| Config has 'download_folder' | FAIL | HIGH | Value: None |
| Config has 'max_concurrent_downloads' | FAIL | HIGH | Value: None |
| Config has 'retry_attempts' | FAIL | HIGH | Value: None |
| Config has 'active_hours' | FAIL | HIGH | Value: None |
| Config loading | FAIL | CRITICAL | Error: 'ConfigManager' object has no attribute 'ma... |
...
| Memory usage idle < 100 MB | PASS | HIGH | Current: 70.54 MB |
