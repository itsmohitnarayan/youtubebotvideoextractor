...
| Test | Status | Severity | Details |
|------|--------|----------|----------|
| Package 'python-dotenv' importable | PASS | HIGH | Import name: dotenv |
| Package 'httpx' importable | FAIL | HIGH | Import error: No module named 'httpx' |
| Package 'requests' importable | FAIL | HIGH | Import error: No module named 'requests' |
| Package 'google-api-python-client' importable | FAIL | HIGH | Import error: No module named 'googleapiclient' |
| Package 'google-auth-oauthlib' importable | FAIL | HIGH | Import error: No module named 'google_auth_oauthli... |
| Package 'google-auth-httplib2' importable | FAIL | HIGH | Import error: No module named 'google_auth_httplib... |
| Package 'yt-dlp' importable | FAIL | HIGH | Import error: No module named 'yt_dlp' |
| Package 'PyQt5' importable | FAIL | HIGH | Import error: No module named 'PyQt5' |
| Package 'PyQt5-Qt5' importable | FAIL | HIGH | Import error: No module named 'PyQt5' |
| Package 'PyQt5-sip' importable | FAIL | HIGH | Import error: No module named 'PyQt5' |
| Package 'APScheduler' importable | FAIL | HIGH | Import error: No module named 'apscheduler' |
| Package 'Pillow' importable | FAIL | HIGH | Import error: No module named 'PIL' |
| Package 'tqdm' importable | FAIL | HIGH | Import error: No module named 'tqdm' |
...
| Memory usage idle < 100 MB | PASS | HIGH | Current: 29.35 MB |
